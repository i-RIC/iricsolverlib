...
/* upper case Fortran name with heading underscore */

#elif defined(_UPPERCASE)
#	define FMNAME(lname,uname) CONCATENATE(_,uname)
#	define FMCALL(lname,uname) CONCATENATE(_,uname)

/* lower case Fortran name with heading underscore */

#elif defined(_LOWERCASE)
#	define FMNAME(lname,uname) CONCATENATE(_,lname)
#	define FMCALL(lname,uname) CONCATENATE(_,lname)
